 ...
 ?>
  ...
  <div style="margin:0 auto;margin-top:0px;background-color:transparent;width:980px;height:auto;" >
    <table cellpadding="0" cellspacing="0">
      ...
      <tr><td>
      <div  style="width:980px;height:auto;background-image:url(images/desafio_fundo.png);background-repeat:repeat-y;margin:0;padding:0;padding-left:40px;">   
       <div style="width:900px;height:1px;"></div>
	  <?				  
        $fases = explode("|",show_menu_fases($rs_desafio["id_desafio"],'','0'));  //motra menu de fases e pega a fase atual do desafio	
		$fase_atual = $fases[0];
		$nome_fase = $fases[1];
		
        desafio_info($rs_desafio["media_flag"],$caminho,$arquivo,$youtube,$rs_desafio["descricao"],$descricao_anexo,$rs_desafio["id_desafio"],$fase_atual,$nome_fase,'1','1');
      ?>
       </div>
