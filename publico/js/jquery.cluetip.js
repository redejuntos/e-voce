  ...
  $.fn.cluetip = function(js, options) {
    ...
    return this.each(function(index) {
      ...
      if (!$('#cluetip').length) {
        ...
        $cluetipTitle = $('<h3 id="cluetip-title" wrap></h3>');        
      ...
      var tipInnerWidth = isNaN(parseInt(opts.width, 10)) ? 'auto' : parseInt(opts.width, 10);
 ...
 */
  ...
  $.fn.cluetip.defaults = {  // set up default options
    ...
    leftOffset:       -50,       // Number of px to offset clueTip from left of invoking element
